...
// Variables
const rootDomain = "ridwan.ridwan-pateemura.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "ridwan.ridwan-pateemura.workers.dev"; // Ganti dengan nama workers kalian
